...
class plgK2StorePayment_cash extends K2StorePaymentPlugin
{
	/**
	 ...
	 * @since 2.5
	 */
	function plgK2StorePayment_cash(& $subject, $config)
	{
    ...
    function _prePayment( $data )
    {
        ...
        $vars->display_name = $this->params->get('display_name', JText::_( "PLG_K2STORE_PAYMENT_CASH"));
    ...
    function _beforePayment($order) {
    	...
    	if($surcharge > 0) {
    		$order->order_surcharge = $surcharge;
