...
<div id="k2Container" class="container-fluid">
	...
	<div class="itemHeader">
	  ...
	  <h2 class="itemTitle text-center bordered-bottom">
  ...
  <div class="itemBody">
	  ...
	  <div class="table">
	  	<div class="cell-40 pad-right pad-bottom-20 bordered-after">
	  	<!-- Item Image -->
			...
			<!-- Item introtext -->
			  ...
			  <div class="itemFullText pad-top-bottom-50">
		...
		<!-- Item extra fields -->
		  ...
		  <div class="itemExtraFields row">
				...
				<?php if($extraField->value != ''): ?>
					<?php if($extraField->name == 'slider-folder'): ?>
						<?php 
						 ...
						 ?>
						<div class="variable-width hidden-xs">
							<?php foreach ($images as $key => $image) : ?>
								<?php $src = $imgDir.'/'.$image;?>

								<div><img class="img-one-height" src="<?php echo $src; ?>" alt=""></div>
							<?php endforeach; ?>
						</div>
						<script>
								NavBarView.addSlick.varWidth();
						</script>
					<?php elseif($extraField->name == 'front-text'): ?>
						<?php $text = preg_split('/<hr \/>/', $extraField->value, -1, PREG_SPLIT_NO_EMPTY);
						      			$cols = 12/count($text); ?>
							<!-- front-text -->
								<div class="container-fluid">
									<div class="row front-text">
										<hr>
										<?php foreach ($text as $key => $str) : ?>
		...
		<!-- Social sharing -->
		<div class="itemSocialSharing margin-top pad-top-bottom-30">
			<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5502cb5b24863922" async="async"></script>
...
<!--
  <div class="itemNavigation">
  	<span class="itemNavigationTitle text-muted"><?php echo JText::_('K2_MORE_IN_THIS_CATEGORY'); ?></span>

		<?php if(isset($this->item->previousLink)): ?>
		<a class="itemPrevious" href="<?php echo $this->item->previousLink; ?>">
			<small class="glyphicon glyphicon-chevron-left"></small> <?php echo $this->item->previousTitle; ?>
		</a> | 
		<?php endif; ?>
		
		<?php if(isset($this->item->nextLink)): ?>
		<a class="itemNext" href="<?php echo $this->item->nextLink; ?>">
			<?php echo $this->item->nextTitle; ?> <small class="glyphicon glyphicon-chevron-right"></small>
		</a>
		<?php endif; ?>
