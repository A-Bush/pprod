...
<!-- ITEM BODY -->
  ...
  <!-- Item Image -->
	  ...
	  <div class="catItemImageBlock product-image">
	    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
	    	<?php 
		    	$dir = $_SERVER['DOCUMENT_ROOT'];
					$imgDir = JURI::root(true).'/images/catalog/'.$this->item->alias;
					$src = $imgDir.'/'.$this->item->alias.'.jpg';
				if (file_exists($dir.$src)) :?>
		    	<img class="img-responsive block-center" src="<?php echo $src; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"/>
		    	<div class="product-image-hover">
		    		<img class="img-responsive block-center" src="<?php echo $imgDir.'/'.$this->item->alias.'-hover.jpg'; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"/>
		    	</div>
		    <?php else : ?>
		    	<img class="img-responsive block-center" src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"/>
				<?php endif; ?>
	    </a>
	  </div>
  ...
  <!-- Item title -->
	  ...
	  <h3 class="catItemTitle text-center no-margin">
	...
	<!-- Item price -->
		...
		<?php $price = json_decode($this->item->plugins)->k2storeitem_price; 
		 if($price) : ?>
		
		<p class="text-center price"><?php echo 'от '.$price.' грн.'; ?></p>
		<?php endif; ?>
