...
<div class="collection">
	<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
		<div class="catItemView-item">	
			<!-- Item Image -->
			  <?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
				<div class="collection-image-container-item">
					<div class="collection-image-item" style="background-image:url(<?php echo $this->item->image;?>)"></div>
			  ...
			  <?php endif; ?>
			<!-- Item inner text -->
			<div class="collection-content-item container">
		  	...
		  	<!-- Item introtext -->
				  <?php if(!empty($this->item->fulltext)): ?>
					  <?php if($this->item->params->get('itemIntroText')): ?>
						  <div class="itemIntroText pad-top">
		...
		<!-- Related items by tag -->
		  <?php if($this->item->params->get('itemRelated') && isset($this->relatedItems)): ?>
				...
				<!-- related image -->
					<div class="product-image">
						...
						<?php if($this->item->params->get('itemRelatedImageSize')): ?>
							...
							<a href="<?php echo $item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
					    	<?php 
						    	$dir = $_SERVER['DOCUMENT_ROOT'];
									$imgDir = JURI::root(true).'/images/catalog/'.$item->alias;
									$src = $imgDir.'/'.$item->alias.'.jpg';
								if (file_exists($dir.$src)) :?>
						    	<img class="img-responsive block-center" src="<?php echo $src; ?>" alt="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>"/>
						    	<div class="product-image-hover">
						    		<img class="img-responsive block-center" src="<?php echo $imgDir.'/'.$item->alias.'-hover.jpg'; ?>" alt="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>"/>
						    	</div>
						    <?php else : ?>
						    	<img class="img-responsive block-center" src="<?php echo $item->image; ?>" alt="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>"/>
								<?php endif; ?>
					    </a>
						<?php endif; ?>
						...
						<!-- related title -->
							<p class="text-center">
								...
								<a class="itemRelTitle text-uppercase" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a>
								<?php endif; ?>
								<?php if(isset($price)) : ?>
								<br>
			...
			<?php endif; ?>
			<hr>
			<div class="fulltext pad-top-bottom-20">
		  <!-- Item fulltext -->
				<?php if(!empty($this->item->fulltext)): ?>
