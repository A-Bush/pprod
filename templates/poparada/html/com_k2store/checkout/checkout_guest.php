...
<div style="display: none !important; clear: both; padding-top: 15px; border-top: 1px solid #DDDDDD;">
...
<div class="buttons row-fluid">
  <div class="right span12 pull-right">
    <input type="button" value="<?php echo JText::_('K2STORE_CHECKOUT_CONTINUE'); ?>" id="button-guest" class="button btn btn-smaller" />
  </div>
</div>
...
(function($){
	...
	(function($){
        $('input#phone_1').attr('placeholder', '+380937014040');
        $('input#first_name').attr('placeholder', 'Матвей');
        $('input#last_name').attr('placeholder', 'Иванов');
        $('input#email').attr('placeholder', 'info@poparada.com.ua');
    })(k2store.jQuery);
