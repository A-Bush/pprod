    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <?php endif; ?>
                ...
                <h2 class="text-center bordered-bottom">
                    ...
                    <form action="<?php echo $action; ?>" method="post" name="adminForm" id="k2store-cart-form" enctype="multipart/form-data">
                        ...
                        <div id="cart_actions">
                       		...
                       		<?php if(isset($continue_shopping_url)):?>
                       		 <a class="btn btn-common begin_checkout" href="<?php echo $continue_shopping_url; ?>">
                                <?php echo JText::_('K2STORE_CONTINUE_SHOPPING'); ?>
                                </a>
                            <?php endif;?>
                            <div class="clearfix"></div>
                            <input style="float: right;" type="submit" class="k2store_cart_button btn btn-smaller" value="<?php echo JText::_('K2STORE_UPDATE_QUANTITIES'); ?>" name="update" />

                          	<?php echo $this->loadTemplate('shipping');?>
            				        <div class="pad-top-bottom-20" style="float: right; clear:both;">
            				        <a class="btn btn-common begin_checkout" href="<?php echo $checkout_url; ?>">
