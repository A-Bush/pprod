	...
	<?php endif; ?>
		...
		<!--base price-->
			<div class="form-group clearfix">
				<span id="product_price_<?php echo $item->product_id; ?>" class="product_price pull-left">
					<?php if($item->special_price > 0.000) echo '<strike>'; ?>
					<span>Цена:</span> 
					<span id="price_eq"><?php  echo K2StoreHelperCart::dispayPriceWithTax($item->price, $item->tax, $this->params->get('price_display_options', 1)); ?></span>
					<?php if($item->special_price > 0.000) echo '</strike>'; ?>
				</span>
	...
	<!-- /.container -->
					...
					<?php if($inventoryCheck->can_allow || $inventoryCheck->backorder):?>
						<div id='add_to_cart_<?php echo $item->product_id; ?>' class="k2store_add_to_cart form-group">
					        ...
					        <input value="<?php echo $cart_text; ?>" type="submit" class="k2store_cart_button btn btn_add_to_cart" />
					    </div>
				     <?php else: ?>
