...
<div class="contaier">
	<div class='row'>
		<div class="span12">
			<h3 class="text-center bordered-bottom"><?php echo JText::_( "K2STORE_ORDER_DETAIL" ); ?></h3>
		</div>
	</div>
	...
	<div class='row'>
		<div class="col-sm-6">
			...
			<?php if(isset($order->event->K2StoreBeforeShippingDisplay)): ?>
						<?php echo $order->event->K2StoreBeforeShippingDisplay; ?>
					<?php endif; ?>
			...
			<?php if(isset($this->shipping_info->ordershipping_type)): ?>
						...
						<dl class="dl-horizontal">
							...
							<dd> <?php echo $selectableBase->getFormatedCustomFields($row, 'customfields', 'payment'); ?> </dd>
						</dl>
			<?php endif; ?>

			<?php if(isset($order->event->K2StoreAfterShippingDisplay)): ?>
						<?php echo $order->event->K2StoreAfterShippingDisplay; ?>
					<?php endif; ?>
...
//									echo $row->billing_address_1 ? $row->billing_address_1.",<br/>" : "";
//									echo $row->billing_address_2 ? $row->billing_address_2.", " : "";
//									echo $row->billing_city ? $row->billing_city.", " : "<br/>";
//									echo $row->billing_zone_name ? $row->billing_zone_name." - " : "";
//									echo $row->billing_zip ? $row->billing_zip."<br/>" : "";
