...
?>
    <div id="k2store_order_info">
        ...
        <table>
            ...
            <tr>
                <strong><?php echo JText::_("K2STORE_BILLING_ADDRESS"); ?> </strong>
            </tr>
            <tr>
                <?php
            ...
            <tr>
                <strong><?php echo JText::_('K2STORE_ORDER_PAYMENT_TYPE'); ?> </strong>
            </tr>
            <tr>
            ...
            <tr>
                <strong><?php echo JText::_("K2STORE_ORDER_CUSTOMER_NOTE"); ?> </strong><br/>
            </tr>
            <tr>
...
<!---->
<!--                            <tr>-->
<!--                                <td valign="top"><strong>--><?php //echo JText::_("K2STORE_BILLING_ADDRESS"); ?><!-- </strong>-->
<!--                                </td>-->
<!--                                <td>-->
<!---->
<!---->
...
<!--                                <tr>-->
<!--                                    <td valign="top">-->
<!--                                        <strong>--><?php //echo JText::_("K2STORE_SHIPPING_ADDRESS"); ?><!-- </strong></td>-->
<!--                                    <td>-->
<!--                                        --><?php
//
