...
class JForm
{
	 ...
	 * @since   11.1
	 */
	public function getField($name, $group = null, $value = null, $class=null)
	{
		...
		return $this->loadField($element, $group, $value, $class);
	}
	 ...
	 * @since   11.1
	 */
	public function getInput($name, $group = null, $value = null, $class=null)
	{
		// Attempt to get the form field.
		if ($field = $this->getField($name, $group, $value, $class))
		{
	 ...
	 * @since   11.1
	 */
	protected function loadField($element, $group = null, $value = null, $class=null)
	{
		...
		if ($field->setup($element, $value, $group, $class))
		{
