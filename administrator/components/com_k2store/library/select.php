...
class K2StoreSelect extends JHtmlSelect
{
	 ...
	 * @return unknown_type
	 */
    public static function productattributeoptionprefix( $selected, $name = 'filter_prefix', $attribs = array('class' => 'input-small', 'size' => '1'), $idtag = null, $allowAny = false, $title = 'Select Prefix' )
    {
        $list = array();
        if($allowAny) {
    ...
    public static function productpricetype( $selected, $name = 'filter_pricetype', $attribs = array('class' => 'input-small', 'size' => '1'), $idtag = null, $allowAny = false, $title = 'Select Price Type' )
    {
    	$list = array();
    	if($allowAny) {
    		$list[] =  self::option('', "- ".JText::_( $title )." -" );
    	...
    	$list[] = JHTML::_('select.option',  'F', JText::_('K2STORE_FIXED') );
    	$list[] = JHTML::_('select.option',  'P', JText::_('K2STORE_PERCENTAGE'));
    	// $list[] = JHTML::_('select.option',  '=', "=" );
