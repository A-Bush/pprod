...
class K2StoreViewGeozones extends K2StoreView
{
	protected $items;
	...
	protected function setDocument() {
		...
		$document->setTitle(JText::_('K2STORE_GEOZONES'));
	}
	...
	protected function getSortFields()
	{
		return array(
				...
				'a.geozone_name' => JText::_('K2STORE_GEOZONE_NAME'),
				'a.geozone_id' => JText::_('K2STORE_GEOZONE_ID')
		);
	}
