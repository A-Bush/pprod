...
class K2StoreToolBar30 extends JToolbar
{
	...
	protected function renderSubmenu()
	{
		$views = array(
				'cpanel',
				'K2STORE_MAINMENU_SALES' => array('orders', 'coupons'),
				'K2STORE_MAINMENU_CATALOG' => array('products', 'options', 'customers'),
...
class JToolbarButtonK2Store30 extends JToolbarButton {
