			...
			else
			{
				...
				if (!empty($attributes))
				{
					...
					foreach ($product_options as $attribute)
					{
						...
						$orderitemattribute->orderitemattribute_short_desc = $attribute->short_desc;
						$orderitemattribute->orderitemattribute_long_desc = $attribute->long_desc;
						$orderitemattribute->orderitemattribute_ref = $attribute->ref;
						$orderitemattribute->orderitemattribute_manage_stock = $attribute->manage_stock;
